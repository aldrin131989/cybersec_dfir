...
!!!DAPAT 7 UNDER92SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
conf t
 ...
 NO ip route 10.92.0.0 255.255.0.0 200.0.0.92
...
conf t
ip routing
ip route 0.0.0.0 0.0.0.0 10.92.100.4
end
...
http://docwiki.cisco.com/wiki/Cisco92IOS92Voice92Troubleshooting92and92Monitoring92--92Tcl92IVR92Troubleshooting
